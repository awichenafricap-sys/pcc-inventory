                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('categories.show', $category->id) }}" class="ml-1 text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white md:ml-2">
                                    {{ $category->name }}
                                </a>
                            </div>
                        </li>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="slug" name="slug" type="text" class="mt-1 block w-full" 
                                              value="{{ old('slug', $category->slug) }}" required placeholder="auto-generated from name" />
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-8 h-8 rounded-full mr-2" style="background-color: {{ old('color', $category->color ?? '#3B82F6') }}"></div>
                                        <span class="text-sm text-gray-600 dark:text-gray-400">{{ old('color', $category->color ?? '#3B82F6') }}</span>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="4" 
                                          ...
                                          placeholder="Optional description about this category">{{ old('description', $category->description) }}</textarea>
