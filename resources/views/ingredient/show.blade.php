                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg text-center">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ $ingredient->minimum_stock }} {{ $ingredient->unit_of_measurement }}</p>
                                </div>
                                @if($ingredient->expiry_date)
                                    <div class="p-4 rounded-lg text-center @if($ingredient->expiry_date <= now()->addDays(7)) bg-red-50 dark:bg-red-900/30 @else bg-gray-50 dark:bg-gray-700 @endif">
