                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        {{-- <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('ingredients.index') }}" class="ml-1 text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white md:ml-2">
                                    All Ingredients
                                </a>
                            </div>
                        </li> --}}
                        @if($selectedCategoryId && $selectedCategory = \App\Models\Category::find($selectedCategoryId))
                            <li>
                                <div class="flex items-center">
                                    <svg class="w-3 h-3 text-gray-400 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
                                    </svg>
                                    <a href="{{ route('categories.show', $selectedCategory->id) }}" class="ml-1 text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white md:ml-2">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-500 dark:text-gray-400 md:ml-2">Add Ingredient</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                    ...
                    <form method="POST" action="{{ route('ingredients.store') }}">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="unit_of_measurement" name="unit_of_measurement" type="text" 
                                                  class="mt-1 block w-full" value="{{ old('unit_of_measurement') }}" required 
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="cost_per_unit" name="cost_per_unit" type="number" 
                                                  step="0.01" class="mt-1 block w-full" 
                                                  value="{{ old('cost_per_unit') }}" placeholder="0.00" />
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="description" name="description" rows="3" 
                                      ...
                                      placeholder="Optional description about this ingredient">{{ old('description') }}</textarea>
                        ...
                        <div class="mt-8 flex justify-end space-x-3">
                            @if($selectedCategoryId && $selectedCategory = \App\Models\Category::find($selectedCategoryId))
                                <a href="{{ route('categories.show', $selectedCategory->id) }}" 
